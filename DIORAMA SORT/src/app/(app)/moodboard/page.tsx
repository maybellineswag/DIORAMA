...
import { Sparkles, Plus, Upload, Wand2, ImagePlus } from "lucide-react";
...
// Pinterest / Are.na brand glyphs (simple inline marks).
    ...
    <div className="mx-auto max-w-7xl space-y-6 p-6 lg:p-8">
      ...
      <div className="flex flex-wrap items-center gap-2">
        ...
        <button
          ...
          className="flex items-center gap-1 rounded-full border border-dashed px-3 py-1.5 text-[13px] text-ink-faint transition-colors hover:text-foreground cursor-pointer"
        >
      ...
      <Dialog open={addOpen} onOpenChange={setAddOpen}>
        <DialogContent className="max-w-sm">
          <DialogHeader>
            ...
            <DialogDescription>
              Create a custom moodboard category.
            </DialogDescription>
          </DialogHeader>
